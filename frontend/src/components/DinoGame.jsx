...
const DinoGame = ({ isPaused }) => {
  ...
  return (
    // Master container: Vertically stacks the Title and the Game Area
    <div className="flex flex-col items-center w-full max-w-[600px] mx-auto select-none p-2 relative group">
      ...
      {/* NEW: Stylish Gradient Title */}
      <div className="w-full flex flex-col items-center mb-6 z-0">
        <h2 className="font-mono text-xl md:text-2xl tracking-[0.3em] font-bold uppercase text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-purple-500 drop-shadow-[0_0_8px_rgba(168,85,247,0.3)]">
          Tic-Tac-Toe
        </h2>
        {/* Subtle glowing underline */}
        <div className="w-32 h-px bg-gradient-to-r from-transparent via-purple-500/50 to-transparent mt-2"></div>
      </div>

      {/* Main Game Area: Side-by-side on desktop, stacked on mobile */}
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-6 md:gap-8 w-full">
        ...
        <div className="flex flex-col w-full max-w-[220px] gap-4 z-20">
          {/* Sleek Animated Dropdown Menu (Accordion Style) */}
